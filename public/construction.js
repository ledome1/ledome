document.head.insertAdjacentHTML("beforeend",'<link rel="stylesheet" href="/construction-overrides.css?v=175">');
...
async function render(){
  ...
  ${projectChatPanel(p)}
  <section class="quick box"><h2>Truy cập nhanh</h2><div class="quick-grid quick-grid-three"><div><b>Cá nhân</b><a data-external-link="/attendance/">Thêm phiếu chấm công</a><a data-app-link="hrm-overtime">Thêm phiếu overtime</a><a data-app-link="hrm-leave">Thêm phiếu xin nghỉ phép</a><a data-view-link="gantt">Thêm phiếu giao nhiệm vụ</a></div><div><b>Công trường</b><a data-form="slip-in">Thêm phiếu nhập kho</a><a data-form="slip-out">Thêm phiếu xuất kho</a><a data-form="expense">Thêm phiếu chi</a></div><div><b>CDT</b><a data-view-link="rfi">Thêm phiếu Yêu cầu Phát sinh của CDT</a><a data-view-link="owner-request">Thêm phiếu Yêu cầu ghi chú của CDT</a><a data-view-link="rfa">Thêm phiếu Yêu cầu cần CDT phê duyệt</a><a data-view-link="issues">Thêm phiếu Vấn đề sự cố</a></div></div></section>
