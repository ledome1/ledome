document.head.insertAdjacentHTML("beforeend",'<link rel="stylesheet" href="/construction-overrides.css?v=168">');
...
function showView(view){
  ...
  if(view==="rfi")return rfiVariationView();
